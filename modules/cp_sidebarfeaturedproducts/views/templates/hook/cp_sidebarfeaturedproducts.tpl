<section class="sidebar-products sidebar-featured block">
  <h2 class="block_title">{l s='Most viewed products' mod='cp_sidebarfeaturedproducts'}</h2>
  <div class="block_content">
            ...
            {if $product.show_price}
              <div class="product-price-and-shipping">
                ...
                {if $product.has_discount}
                  <span class="sr-only">{l s='Regular price' mod='cp_sidebarfeaturedproducts'}</span>
    ...
    <a href="{$allProductsLink}" class="allproducts btn btn-primary">{l s='All products' mod='cp_sidebarfeaturedproducts'}</a>
  </div>
</section>
