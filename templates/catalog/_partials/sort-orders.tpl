...
{* The search provider supplies labels through its own translation catalogue. *}
...
<div class="{if !empty($listing.rendered_facets)}col-xs-8 col-sm-7{else}col-xs-12 col-sm-12{/if} col-md-9 products-sort-order dropdown">
  <div class="b2b-sort-control dropdown">
    <button
      ...
      aria-haspopup="true"
      aria-expanded="false">
      <span class="b2b-sort-label">{if $listing.sort_selected}{$listing.sort_selected|escape:'html':'UTF-8'}{else}{l s='Choose' d='Shop.Theme.Actions'}{/if}</span>
